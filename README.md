...
- ⚙️ **Configuration Management** — Environment-specific settings via xcconfig files with type-safe access
...
│   │       └── Assets.xcassets
│   └── Configuration/
│       ├── Debug.xcconfig                # Debug environment config
│       ├── Release.xcconfig              # Release environment config
